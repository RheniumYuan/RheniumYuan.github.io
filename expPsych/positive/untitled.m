...
outputFolder = 'E:\\PSYCH2023\\jsPsych2023\\experiment\\exp_v2\\图片\\实心大作业图片\\正性图片\\output'; % 你可以修改为你的实际路径
...
for i = 1:nfiles
    ...
    rect = [centerX - 300, centerY - 300, 599, 599]; % 定义裁剪的矩形区域
    croppedImage = imcrop(image, rect); % 裁剪图像
    
    % 重命名图像文件，假设你要用数字序号来重命名，你可以根据需要修改
    newName = sprintf('Positive%03d.jpg', i); % 定义新的文件名
